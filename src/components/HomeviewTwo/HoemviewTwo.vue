<template>
    ...
    <div class="text-white m-5 mt-[128px] md:mt-[150px] lg:ml-[150px]">
        ...
        <h2 class="text-[27px] md:text-[36px] lg:text-[61px] font-[900] font-sans mt-[18px] md:ml-[104px] lg:ml-[128px] lg:w-[60%]">{{$t('translation.homeviewTwo.two')}}</h2>
    ...
    <div class="grid md:flex justify-center items-center gap-4 mt-[64px] md:mt-[96px] lg:mt-[128px] my-10">
        <div class="w-[100%] md:w-[232px] md:h-[232px] lg:w-[400px] lg:h-[250px] 2xl:w-[30%] mx-auto rounded-[16px] bg-gradient-to-t from-[#242B3D] to-[#999FB0] p-0.5">
            <div class="md:h-[227px] lg:h-[245px] p-5 md:p-2 rounded-[16px] bg-[#171B3F] opacity-90">
                ...
                <div class="text-white mt-[24px]">
                    <h2 class="text-[27px] md:text-[20px] lg:text-[27px] font-[700] md:pl-3 lg:pl-[24px] font-sans text-center md:text-left">{{$t('translation.homeviewTwo.card.one')}}</h2>
        ...
        <div class="w-[100%] md:w-[232px] md:h-[232px] lg:w-[400px] lg:h-[250px] 2xl:w-[30%] mx-auto rounded-[16px] bg-gradient-to-t from-[#242B3D] to-[#999FB0] p-0.5">
            <div class="md:h-[227px] lg:h-[245px] p-5 md:p-2 rounded-[16px] bg-[#171B3F] opacity-90">
                ...
                <div class="text-white mt-[24px]">
                    <h2 class="text-[27px] md:text-[20px] lg:text-[27px] font-[700] md:pl-3 lg:pl-[24px] font-sans text-center md:text-left">{{$t('translation.homeviewTwo.card.two')}}</h2>
        ...
        <div class="w-[100%] md:w-[232px] md:h-[232px] lg:w-[400px] lg:h-[250px] 2xl:w-[30%] mx-auto rounded-[16px] bg-gradient-to-t from-[#242B3D] to-[#999FB0] p-0.5">
            <div class="md:h-[227px] lg:h-[245px] p-5 md:p-2 rounded-[16px] bg-[#171B3F] opacity-90">
                ...
                <div class="text-white mt-[24px]">
                    <h2 class="text-[27px] md:text-[20px] lg:text-[27px] font-[700] md:pl-3 lg:pl-[24px] font-sans text-center md:text-left">{{$t('translation.homeviewTwo.card.three')}}</h2>
