<template>
    <div class="text-white m-5 mt-[68px] md:mt-[150px] lg:ml-[150px]">
        <p id="yangi" class="text-[16px] font-[700] md:text-[21px] md:ml-[104px] lg:ml-[128px]">{{$t('translation.homeviewfour.one')}}</p>
        <h2 class="text-[27px] md:text-[36px] lg:text-[61px] font-[900] font-sans mt-[18px] md:ml-[104px] lg:ml-[128px] lg:w-[60%]">{{$t('translation.homeviewfour.two')}}</h2>
        <p class="text-[16px] md:text-[21px] mt-[32px] md:ml-[104px] lg:ml-[128px] lg:w-[50%]">{{$t('translation.homeviewfour.three')}}</p>
    </div>
